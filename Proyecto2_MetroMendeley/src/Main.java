...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El indice del resumen 1 es:" + index);
        System.out.println("El indice del resumen 2 es:" + index2);
        System.out.println("El indice del resumen 3 es:" + index3);
        System.out.println("El indice del resumen 4 es:" + index4);
